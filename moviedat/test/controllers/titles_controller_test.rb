...
class TitlesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create title" do
    assert_difference('Title.count') do
      post titles_url, params: { title: { cast: @title.cast, movie_url: @title.movie_url, plat: @title.plat, poster_url: @title.poster_url } }
    end
  ...
  test "should update title" do
    patch title_url(@title), params: { title: { cast: @title.cast, movie_url: @title.movie_url, plat: @title.plat, poster_url: @title.poster_url } }
